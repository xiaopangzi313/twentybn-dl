...
from twentybn_dl import ExecutorResultProcessor
...
class TestExecutorResultProcessor(unittest.TestCase):
    ...
    @mock.patch(
        'twentybn_dl.ExecutorResultProcessor.process_results')
    @mock.patch(
        'twentybn_dl.ExecutorResultProcessor.print_processed_results')
